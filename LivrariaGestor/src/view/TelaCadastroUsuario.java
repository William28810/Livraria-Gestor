...
public class TelaCadastroUsuario extends javax.swing.JFrame {
     ...
     */
    public TelaCadastroUsuario(PainelUsuario painelUsuario) {
        initComponents();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnSalvar, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        String permissao = txtPermissao.getText().trim();
        String senha = txtSenha.getText().trim();
        String login = txtLogin.getText().trim();

        if (nome.isEmpty() || cargo.isEmpty() || permissao.isEmpty() || senha.isEmpty() || login.isEmpty()) {
        ...
        //Converter valore
        Funcionario funcionario = new Funcionario(nome, cargo, permissao, login, senha);
        ...
        if(painelUsuario !=null){
        painelUsuario.carregarUsuario();
    ...
    public void setDadosUsuario(int id, String nome, String cargo, String nivelPermissao, String login, String senha){
        this.idFuncionario = id;
        
        txtNome.setText(nome);
        txtCargo.setText(cargo);
        txtPermissao.setText(nivelPermissao);
